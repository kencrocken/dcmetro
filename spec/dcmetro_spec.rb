...
describe DCMetro::Cli do
  ...
  describe '#dcmetro lines' do
    it 'should echo metro lines' do
      ...
      expect(echo_task).to include "\e[0;94mBlue\e[0m\n\e[0;32mGreen\e[0m\n\e[38;5;208mOrange\e[0m\n\e[0;31mRed\e[0m\n\e[0;90mSilver\e[0m\n\e[0;93mYellow\e[0m\n"
    end
  end
  ...
  describe '#dcmetro lines red' do
    it 'should echo metro stations on the red line' do
      echo_task = capture(:stdout) { DCMetro::Cli::Application.start(%w[line red]) }
  ...
  describe '#dcmetro station gallery' do
    it 'should echo predictions for Gallery Place' do
      gallery = 'gallery'
      echo_task = capture(:stdout) { DCMetro::Cli::Application.start(%w[station gallery]) }
      expect(echo_task.downcase).to include gallery.downcase
    end
  end
  ...
  describe '#dcmetro travel college gallery' do
    it 'should echo fare information from college park to gallery place' do
      echo_task = capture(:stdout) { DCMetro::Cli::Application.start(%w[travel college gallery]) }
